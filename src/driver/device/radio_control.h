...
#define RC_ROLL_ANGLE_MAX 45.0
#define RC_ROLL_ANGLE_MIN -45.0

#define RC_PITCH_ANGLE_MAX 45.0
#define RC_PITCH_ANGLE_MIN -45.0

#define RC_YAW_RATE_MAX 45.0
#define RC_YAW_RATE_MIN -45.0
